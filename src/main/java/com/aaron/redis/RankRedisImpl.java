...
public class RankRedisImpl implements RankRedis {
    ...
    public List<RankRedis.RankTuple> getAllRank() {
        List<RankRedis.RankTuple> rankTuples = new ArrayList<RankRedis.RankTuple>();
        ...
        for (ZSetOperations.TypedTuple<Long> typedTuple : set) {
            rankTuples.add(new RankRedis.RankTuple(typedTuple.getValue(), typedTuple.getScore().longValue()));
        }
        return rankTuples;
    }
